...
1. Read folder-structure.md and place new files under src/modules/leave-management/ only.
...
11. Commit on ai/build-001-leave-management, push, open a PR titled "BUILD-001: Leave Management".
