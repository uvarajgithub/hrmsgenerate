...
## What to build
- REQ-EMPLOYEE-01: Create Employee Profile (Employee Management)
- REQ-EMPLOYEE-02: Verify & Validate Employee Details (Employee Management)
- REQ-EMPLOYEE-03: Submit for Manager Approval (Employee Management)
- REQ-EMPLOYEE-04: Manager Reviews Employee Record (Employee Management)
- REQ-EMPLOYEE-05: Approve Employee Record (Employee Management)
- REQ-EMPLOYEE-06: Activate Employee (Employee Management)
- REQ-EMPLOYEE-07: Update Employee Information (Employee Management)
- REQ-EMPLOYEE-08: Deactivate / Offboard Employee (Employee Management)
- REQ-EMPLOYEE-09: Audit Log Capture (Employee Management)
- REQ-EMPLOYEE-10: Generate Employee Reports (Employee Management)
